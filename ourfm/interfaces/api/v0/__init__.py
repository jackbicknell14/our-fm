...
from .user import UserTrackCurrent, UserContact, User, UserGroup, UserPlaylist
...
resources.add(base_api, UserContact, '/user/contacts', endpoint='user-contacts')
resources.add(base_api, UserGroup, '/user/groups', endpoint='user-groups')
resources.add(base_api, UserPlaylist, '/user/playlists', endpoint='user-playlist')
